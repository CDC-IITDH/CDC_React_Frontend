              ...
              >
                ...
                <div className="text">
                  ...
                  <p style={{ marginBottom: "30px", textAlign: "justify" }}>
                    ...
                    knowledge, we also impart hands on knowledge and industry
                    relevant skills to our students, to enable them to thrive in
                    any setting. Through organizing various events and
              ...
              >
                ...
                <div className="text">
                  ...
                  <p style={{textAlign:"justify"}}>
                    ...
                    be a complete professional. It is committed to assisting all
                    IIT Dharwad students in achieving their career goals. To
                    achieve the same, it organizes events like pre-placement'
                    training programs and various talk series to facilitate the
                    Industry Institute Interface, to name a few.The institute
                    aims to make education an innovative It is also responsible
                    for facilitating campus internships and placements for the
