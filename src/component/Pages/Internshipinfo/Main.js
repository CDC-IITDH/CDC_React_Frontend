    ...
    <div style={styles.desktop}>
      <div style={isDesktop? styles.tableTitle:styles.mobile}>
        <h3 style={styles.tableTitleH3}>
          The Career Development Cell (CDC) at IIT Dharwad is responsible for facilitating the internship process for the students. The CDC acts as an interface between the industry and the students, and primarily enables the students to select the internship of their choice. The CDC also helps the companies in recruiting the best talent from the institute.
        </h3>
        ...
        <h5 style={styles.subText}>c) A brief description of the job and responsibilities, required skill set and selection process.</h5>
        </div>
        </div>
        <div style={styles.section}>
        <h4 style={styles.sectionTitle}>2. Preassessment / Shortlist</h4>
        <div style={styles.sub1}>
        <h5 style={styles.text}>Resumes of the interested students are made available to the companies. The companies shortlist the students on the basis of their resumes.</h5>
        </div>
        </div>
        <div style={styles.section}>
        <h4 style={styles.sectionTitle}>3. Examination / Test</h4>
        <div style={styles.sub1}>
        <h5 style={styles.text}>Companies conduct various examinations in the form of written or online tests. The students are eligible for the further process on the basis of their performance in the examination.</h5>
        </div>
        </div>
         <div style={styles.section}>
        <h4 style={styles.sectionTitle}>4. Interview</h4>
        <div style={styles.sub1}>
        <h5 style={styles.text}>After the preliminary test/examination, the company will send us the list of the students shortlisted for the interview and the details about the schedule of interview. If needed the CDC will help in arranging for the interview in the campus.</h5>
        </div>
        </div>
        <div style={styles.section}>
        <h4 style={styles.sectionTitle}>5. Offer</h4>
        <div style={styles.sub1}>
        <h5 style={styles.text}>After the interview, the company will send out offer letters to the students selected, offering to join the company.</h5>
        </div>
        </div>
        <div style={styles.section}>
        <h4 style={styles.sectionTitle}>6. Student Accept / Reject</h4>
        <div style={styles.sub1}>
        <h5 style={styles.text}>The final decision of whether to accept or reject the offer rests with the student, and the student has to inform about this decision within the stipulated time.</h5>
        </div>
        </div>
      </div>
    </div>
